...
def dfs(root, innerNodes, leaf):
    if (isinstance(root, Leaf)):
        leaf.append(root)
        return 
    dfs(root.false_branch, innerNodes, leaf)
    dfs(root.true_branch, innerNodes, leaf)
    innerNodes.append(root)
    return
